...
module "subnets" {
  source   = "github.com/devc4sh/terraformcloud/test_tf/tf_cloud_test/modules/subnet"
...
module "nat" {
  source    = "github.com/devc4sh/terraformcloud/test_tf/tf_cloud_test/modules/nat"
...
module "route" {
  source   = "github.com/devc4sh/terraformcloud/test_tf/tf_cloud_test/modules/route"
